package com.example.jetpackcomposelayout.ui.theme.signup
...
import com.example.jetpackcomposelayout.ui.theme.components.LoginTextField
import com.example.jetpackcomposelayout.ui.theme.login.LoginScreen
import com.example.jetpackcomposelayout.ui.theme.login.defaultPadding

@Composable
fun SignUpScreen(
    onSignUpClick: () -> Unit,
    onLoginClick: () -> Unit,  // Ini akan diubah di MyNavigation
    onPolicyClick: () -> Unit,
    onPrivacyClick: () -> Unit,
) {
    ...
    val passwordStatus = isPasswordSame.value  // Untuk membaca nilai
    ...
    Column(
        ...
        AnimatedVisibility(visible = !passwordStatus) {
            Text(
        ...
        HeaderText(
            text = "Sign Up",
            imageResId = R.drawable.capoeiralogo,
        ...
        Button(
            onClick = {
                isPasswordSame.value = password == confirmPassword
